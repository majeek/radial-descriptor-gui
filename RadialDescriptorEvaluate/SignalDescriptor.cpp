...
SignalDescriptor::SignalDescriptor(int row, int col, int radius, double variance, cv::Mat signal) : fRow(row), fCol(col), fRadius(radius), fVariance(variance), fSignal(signal), fCluster(-1){
